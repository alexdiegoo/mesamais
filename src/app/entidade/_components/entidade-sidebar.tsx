...
export function EntidadeSidebar() {
  const pathname = usePathname();

  const menu = [
    { label: "Solicitar Alimentos", href: "/entidade", icon: Home },
    { label: "Histórico de Recebimentos", href: "/entidade/historico", icon: History },
    { label: "Perfil", href: "/entidade/perfil", icon: User },
  ];
